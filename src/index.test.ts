...
vi.mock("./commands/screenshot/index.js", () => ({
  screenshotCommand: vi.fn().mockReturnValue("mocked-screenshot-command"),
}));

vi.mock("./commands/design-feedback/index.js", () => ({
  designFeedbackCommand: vi.fn().mockReturnValue("mocked-design-feedback-command"),
}));

vi.mock("./commands/tmux/index.js", () => ({
...
vi.mock("./commands/scaffold/index.js", () => ({
  createScaffoldCommand: vi.fn().mockReturnValue("mocked-scaffold-command"),
}));
...
describe("CLI", () => {
  it("should initialize correctly", async () => {
    ...
    expect(mockCommandInstance.addCommand).toHaveBeenCalledWith("mocked-scaffold-command");
